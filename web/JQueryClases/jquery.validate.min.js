...
!function (a) {
    ...
    a.extend(a.fn, {validate: function (b) {
        ...
        return 1 === arguments.length ? function () {
            ...
            email: "Por favor inserte una cuenta de correo valida.", 
            ...
            minlength: a.validator.format("Por favor inserte al menos {0} caracteres."), 
            rangelength: a.validator.format("Please enter a value between {0} and {1} characters long."), 
            range: a.validator.format("Please enter a value between {0} and {1}."), 
            max: a.validator.format("Please enter a value less than or equal to {0}."), 
            min: a.validator.format("Please enter a value greater than or equal to {0}.")}, autoCreateRanges: !1, prototype: {init: function () {
                function b(b) {
